		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapcommanagepurchaseorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcommanagepurchaseorder-display": {
								"semanticObject": "sapcommanagepurchaseorder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.managepurchaseorder",
									"url": sap.ui.require.toUrl("sap/com/managepurchaseorder")
								}
							}
						}
					}
